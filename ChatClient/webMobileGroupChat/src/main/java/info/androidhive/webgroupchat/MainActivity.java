...
public class MainActivity extends Activity {
	...
	private static final String TAG_SELF = "self", TAG_NEW = "new",
			TAG_MESSAGE = "message", TAG_EXIT = "exit", TAG_CARD = "card";
	...
	private void parseMessage(final String msg) {
		...
		try {
			...
			} else if(flag.equalsIgnoreCase(TAG_CARD)){
				String name = jObj.getString("name");
				String suit = jObj.getString("suit");
				String owner = jObj.getString("owner");
				showToast("The owner is: " + owner + "Value: "+ name+ "Suit: " + suit);
				String message = "The owner is: " + owner + " Value: "+ name+ " Suit: " + suit;
				Message m = new Message(owner,message,false);
				appendMessage(m);
			}
